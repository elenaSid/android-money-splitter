 ...
 *         Time: 10:22
 */
class FamilyAdapter(val listener: FamilyListener, val families: List<FamilyEntity>) : androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder>() {
